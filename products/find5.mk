...
# boot animation
PRODUCT_COPY_FILES += \
    vendor/behelit/prebuilt/bootanimation/bootanimation_1080_1920.zip:system/media/bootanimation-alt.zip

PRODUCT_PACKAGE_OVERLAYS += vendor/behelit/overlay/find5

# Device identifier. This must come after all inclusions
PRODUCT_DEVICE := find5
PRODUCT_NAME := crimson_find5
PRODUCT_BRAND := Oppo
